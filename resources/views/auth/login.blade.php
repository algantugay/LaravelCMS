...
<html lang="en">
	...
	<body id="kt_body" class="auth-bg bgi-size-cover bgi-attachment-fixed bgi-position-center">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Page bg image-->
			<style>body { background-image: url('{{asset('backend/assets/media/auth/bg10.jpeg')}}'); } [data-bs-theme="dark"] body { background-image: url('{{asset('backend/assets/media/auth/bg10-dark.jpeg')}}'); }</style>
			<!--end::Page bg image-->
					...
					<div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
						...
						<div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
							...
							<div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
								<!--begin::Form-->
								<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="{{ route('dashboard') }}" method="POST" action="{{ route('login') }}"> @csrf
									<!--begin::Heading-->
									...
									<div class="text-center mb-11">
										...
										<!--end::Title-->
										<!--begin::Subtitle-->
										<div class="text-gray-500 fw-semibold fs-6">Dilediğin Gibi</div>
										<!--end::Subtitle=-->
									</div>
									...
									<div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
										<div></div>
										<!--begin::Link-->
										<a href="../../demo8/dist/authentication/layouts/overlay/reset-password.html" class="link-primary">Şifremi Unuttum ?</a>
										<!--end::Link-->
									</div>
									<!--end::Wrapper-->
									<!--begin::Submit button-->
