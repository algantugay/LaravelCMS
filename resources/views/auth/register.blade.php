            ...
            <div class="d-flex flex-lg-row-fluid">
                ...
                <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                    ...
                    <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                        src="{{ asset('backend/assets/media/auth/agency.png') }}" alt="" />
                    <img class="theme-dark-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                        src="{{ asset('backend/assets/media/auth/agency-dark.png') }}" alt="" />
                    <!--end::Image-->
                    <!--begin::Title-->
                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                            ...
                            <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form"
                                ...
                                <div class="fv-row mb-8" data-kt-password-meter="true">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            ...
                                            <input class="form-control bg-transparent" type="password"
                                                placeholder="Şifre" name="password" autocomplete="off" required />
                                            <span
                                    ...
                                    <!--end::Wrapper-->
                                    <!--begin::Hint-->
                                    <div class="text-muted">Harf, rakam ve simgelerin karışımından oluşan 8 veya daha
                                        fazla karakter kullanın.</div>
                                    <!--end::Hint-->
                                </div>
                                <!--end::Input group=-->
                                <!--end::Input group=-->
                                <div class="fv-row mb-8">
                                    ...
                                    <input placeholder="Şifre Tekrar" name="password_confirmation"
                                ...
                                <div class="text-gray-500 text-center fw-semibold fs-6">Zaten Hesabınız Var Mı?
                                    <a href="{{ route('login') }}" class="link-primary fw-semibold">Giriş Yap</a>
                                </div>
                                <!--end::Sign up-->
                            </form>
                            <!--end::Form-->
