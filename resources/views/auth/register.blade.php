					...
					<div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
						...
						<div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
							...
							<div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
								<!--begin::Form-->
								<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" action="{{ route('register') }}" method="POST" data-kt-redirect-url="{{ route('login') }}" action="#">
									<!--begin::Heading-->
									...
									<div class="fv-row mb-8" data-kt-password-meter="true">
										...
										<div class="mb-1">
											...
											<!--begin::Password-->
												<input class="form-control bg-transparent" type="password" placeholder="Şifre" name="password" autocomplete="off" required />
									...
									<div class="fv-row mb-8">
										...
										<input placeholder="Şifre Tekrar" name="password_confirmation" id="password_confirmation" type="password" autocomplete="off" class="form-control bg-transparent" required />
										<!--end::Repeat Password-->
									</div>
									<!--end::Input group=-->
									<!--begin::Accept-->
									<div class="fv-row mb-8">
										<label class="form-check form-check-inline">
											...
											<a href="#" class="ms-1 link-primary">Şartları</a></span>
									...
									<!--end::Submit button-->
									<!--begin::Sign up-->
									<div class="text-gray-500 text-center fw-semibold fs-6">Zaten Hesabınız Var Mı?
